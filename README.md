...
Here are the technologies and tools I actively use and learn during my academic journey:
...
<table width="100%">
  <tr>
    <!-- PROJECT 1: SERENITY MENTAL HEALTH CARE -->
    <td width="50%" valign="top">
      <h4>🧠 Serenity Mental Health Care System</h4>
      <p>A robust and fully-fledged enterprise-level management solution designed to streamline and digitize mental health care operations, focusing on high performance and data visibility.</p>
      <p>
        <code>Java</code> &nbsp; <code>JavaFX</code> &nbsp; <code>Hibernate ORM</code> &nbsp; <code>MySQL</code> &nbsp; <code>Layered Architecture</code>
      </p>
      <ul>
    ...
    <td width="50%" valign="top">
      <h4>📂 NRL Bag Management System</h4>
      <p>A standalone desktop application developed as a Semester 1 final project to digitize and automate the manual operations of a small-scale bag manufacturing business.</p>
      <p>
        <code>Java</code> &nbsp; <code>JavaFX</code> &nbsp; <code>MySQL</code> &nbsp; <code>IntelliJ IDEA</code>
      </p>
      <ul>
        <li>Transformed a fully manual, notebook-based workflow into a centralized, efficient digital solution.</li>
